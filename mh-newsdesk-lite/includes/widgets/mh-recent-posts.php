...
class mh_newsdesk_lite_recent_posts extends WP_Widget {
    function mh_newsdesk_lite_recent_posts() {
        $widget_ops = array('classname' => 'mh_newsdesk_lite_recent_posts', 'description' => __('Display a list of most recent posts.', 'mh-newsdesk-lite'));
        $this->WP_Widget('mh_newsdesk_lite_recent_posts', __('MH Recent Posts', 'mh-newsdesk-lite'), $widget_ops);
    }
