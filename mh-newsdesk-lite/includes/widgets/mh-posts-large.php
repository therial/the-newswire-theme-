...
class mh_newsdesk_lite_posts_large extends WP_Widget {
    function mh_newsdesk_lite_posts_large() {
        $widget_ops = array('classname' => 'mh_newsdesk_lite_posts_large', 'description' => __('Display post with large image on front page for use in "Home 1" or "Home 4" widget areas.', 'mh-newsdesk-lite'));
        $this->WP_Widget('mh_newsdesk_lite_posts_large', __('MH Posts Large (lite)', 'mh-newsdesk-lite'), $widget_ops);
    }
